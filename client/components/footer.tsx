...
const Footer = () => {
  return (
    ...
    <div className="w-full mx-auto container md:p-8 p-6 md:flex md:items-center md:justify-between">
      <span className="text-md text-gray-500">© 2023 <Link href="/" className="hover:underline">SeuJob™</Link>. All Rights Reserved.
        </span>
